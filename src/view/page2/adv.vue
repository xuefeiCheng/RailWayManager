  ...
  <div ref="divWidth" class="div-border">
    <Form ref="search" :model="search" :label-width="80">
      <Row>
        <Col span="8">
          <FormItem label="输入条件">
            <Input type="text" v-model="search.name" placeholder="请输入想要查询的条件" />
          </FormItem>
        </Col>
        <Col span="8">
          <FormItem label="业务类型">
    ...
    <Button type="primary" icon="ios-add-circle-outline" @click="singleAdd" style="display:none;">新增</Button>
    <Table
      border
      ...
      tableData: [
        {
          ...
          successNum: '源IP',
          failNum: '源IP_20190604.xls'
        },
        {
          name: '响一声提醒下发',
          createTime: '201906041334',
          successNum: '源端口',
          failNum: '源端口_20190604.xls'
        },
        {
          name: '恶意“呼死你”提醒下发',
          createTime: '201906041334',
          successNum: '协议类型',
          failNum: '协议类型_20190604.xls'
        },
        {
          name: '低频诈骗提醒下发',
          createTime: '201906041334',
          successNum: '目的IP',
          failNum: '目的IP_20190604.xls'
        }
      ],
      pageConfig: {
        total: 4,
