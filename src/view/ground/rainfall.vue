    ...
    <div class="box-left flex flex-direction-coloum space-between">
      ...
      <div class="box-left-top border-normal flex space-between" v-show="!gather">
        ...
        <div class="image" style="overflow:hidden">
          <img src="../../../static/img/railway/u1251.jpg" alt="" style="width:100%;">
          <div>
              ...
              <Col span="4">
                <FormItem label="统计类型">
                  <Select v-model="search.type">
                    <Option value="1">日降雨量</Option>
                    <Option value="2">小时降雨量</Option>
                  </Select>
                </FormItem>
              </Col>
              <Col span="4">
                    ...
                    if (val) {
                      if (custType !== this.baseType) {
                        ...
                        if (this.custType) {
                          ...
                          this.$Message.error('非降雨量数据仅可选择一条')
                          // 勾选状态更新为之前状态
                          this.$nextTick(() => {
                            this.$refs.test.$refs.tbody.objData[params.index]._isChecked = !val
                          })
