<template lang="html">
  <div class="div-border">
    ...
    <!-- 审核模态框 -->
    <Modal v-model="auditModal" title="策略审核" @on-ok="auditOK('audit')" @on-cancel="auditCancel('audit')" :loading="audit.loading" class="overflowlll">
    ...
    <!-- 新增模态框 -->
    <Modal v-model="addModal" title="策略配置" @on-ok="addOK('audit')" @on-cancel="addCancel('audit')" :loading="add.loading" width="60%" class="overflowlll">
  ...
  data () {
    return {
      ...
      normList: [
        ...
        {
          'id': 3,
          'normName': 'short_connoffset_rate',
          'normDesc': '主叫挂断率',
          'normRelation': 1,
          'normRemark': '主叫挂断率',
          'level': 1
        ...
        {
          'id': 5,
          'normName': 'called_distinct',
          'normDesc': '被叫离散度',
          'normRelation': 1,
          'normRemark': '被叫号码个数占总通话次数的百分比',
          'level': 1
        },
        {
          'id': 6,
          'normName': 'avg_alert_noAnswer',
          'normDesc': '接通率',
          'normRelation': 1,
          'normRemark': '',
          'level': 1
      ...
      table: {
        ...
        data: [
          {
            'id': 18,
            'strategyName': '渠道开卡分析模型',
            'state': 1,
            'lastdata': '20191220960817',
            'cycle': 10,
            'period': 120,
            'rule': 1,
            'formula': '2>=12',
            'createTime': '20191220130803'
          },
          {
            'id': 17,
            'strategyName': '高危地区位置分析模型',
            'state': 1,
            'lastdata': '20191220160817',
            'cycle': 10,
            'period': 120,
            'rule': 1,
            'formula': '0>=123',
            'createTime': '20191220100654'
          },
          {
            'id': 15,
            'strategyName': '诈骗骚扰行为分析模型',
            'state': 2,
            'lastdata': '20191220160817',
            'cycle': 10,
            'period': 120,
            'rule': 2,
            'formula': '1>=1234__0<=2344',
            'createTime': '20191220140308'
          },
          {
            'id': 14,
            'strategyName': '交际圈分析模型',
            'state': 2,
            'lastdata': '20191220160817',
            'cycle': 5,
            'period': 60,
          ...
          },
          {
            ...
            'rule': 2,
            'formula': '0>=123',
            'createTime': '20191219202240'
          },
          {
            'id': 4,
            'strategyName': '高危imei拓查',
            'state': 1,
            'lastdata': '20191119183630',
            'cycle': 5,
            'period': 60,
            'rule': 1,
            'formula': '1>=10__2<=10__3>=100',
            'createTime': '20191119162217'
          }
        ]
      },
      auditModal: false,
...
.overflowlll >>> .ivu-modal-body {
  overflow: visible;
}
.overflowlll >>> .ivu-table-wrapper{
  overflow: initial;
}
.overflowlll >>> .ivu-table {
  overflow: auto;
}
element.style {
