...
export default {
  ...
  mounted () {
    ...
    this.drawMap('map', Data.jiangximap)
  ...
  methods: {
    ...
    drawMap (id, data) {
      ...
      // 江西气泡 经纬度
      let dataList = [
        {'name': '宜春市', wz: [114.391136, 27.8043]},
        {'name': '新余市', wz: [114.930835, 27.810834]},
        {'name': '赣州市', wz: [114.940278, 25.85097]},
        {'name': '吉安市', wz: [114.986373, 27.111699]},
        {'name': '鹰潭市', wz: [117.033838, 28.238638]},
        {'name': '上饶市', wz: [117.971185, 28.44442]},
        {'name': '南昌市', wz: [115.892151, 28.676493]},
        {'name': '抚州市', wz: [116.358351, 27.98385]},
        {'name': '萍乡市', wz: [113.852186, 27.622946]},
        {'name': '九江市', wz: [115.992811, 29.712034]},
        {'name': '景德镇市', wz: [117.214664, 29.29256]}
      ]
